...
public class GameManager : Photon.MonoBehaviour
{
    ...
    public void SpawnPlayer()
    {
        ...
        { 
            ...
            PhotonNetwork.Instantiate(PlayerPrefab[checkPlayers()].name, new Vector3(Locations[checkPlayers()].x, Locations[checkPlayers()].y, Locations[checkPlayers()].z),LocationsRotation[checkPlayers()], 0);
